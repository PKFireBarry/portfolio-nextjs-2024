...
function Header() {
  return (
    <header className="sticky top-5 h-[33px] w-[95%] flex items-center justify-between max-w-6xl mx-auto z-20 p-5 bg-ghostwhite rounded-full border-4 bg-white border-black">
  <div
